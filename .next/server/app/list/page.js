...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 85867)), "C:\\Users\\azkjh\\OneDrive\\바탕 화면\\project\\yangsubi\\app\\list\\page.js"],
    ...
    const pages = ["C:\\Users\\azkjh\\OneDrive\\바탕 화면\\project\\yangsubi\\app\\list\\page.js"];
...
/* harmony import */ var _firebase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11624);
...
/* harmony import */ var _components_Card__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(63541);
...
function ListItem({ result  }) {
    const [r, setR] = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)(null);
            ...
            if (result.urls && result.imageRefs) {
                const deleteImage = async ()=>{
                    for(let i = 0; i < result.imageRefs.length; i++){
                        const imageRef = (0,firebase_storage__WEBPACK_IMPORTED_MODULE_3__/* .ref */ .iH)(_firebase__WEBPACK_IMPORTED_MODULE_2__/* .storage */ .t, result.imageRefs[i]._location.path_);
                        await (0,firebase_storage__WEBPACK_IMPORTED_MODULE_3__/* .deleteObject */ .oq)(imageRef).then(()=>{
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: r && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Card__WEBPACK_IMPORTED_MODULE_5__["default"], {
            result: result,
            list: "list"
        })
    });
...
// EXTERNAL MODULE: ./util/database.js
var database = __webpack_require__(93709);
...
;// CONCATENATED MODULE: ./app/list/ListItem.js

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\azkjh\OneDrive\바탕 화면\project\yangsubi\app\list\ListItem.js`)
...
const List = async ()=>{
    let session = await (0,next_auth.getServerSession)(_nextauth_/* authOptions */.L);
    if (!session) {
        (0,navigation.redirect)("/");
    }
    const client = await database/* connectDB */.u;
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "m-4",
        children: result && /*#__PURE__*/ jsx_runtime_.jsx(ListItem, {
            result: result
        })
    });
};
/* harmony default export */ const page = (List);
...
var __webpack_exports__ = __webpack_require__.X(0, [211,159,24,198,549,725,541,433], () => (__webpack_exec__(68809)));
